...
declare namespace THREE {
   ...
   // custom blending src factors
    ...
    export class Object3D extends EventDispatcher {
        ...
        addComponent<T extends {constructor:T}>(classConstructor: T): T;
        getComponent<T extends {constructor:T}>(classConstructor: T): T;
        removeComponent<T extends {constructor:T}>(classConstructor: T): T;
